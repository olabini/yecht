       ...
       while(true) {
        ...
        gotoNext: while(gotoPoint != -2) {
            ...
            case -1: 
                ...
                yych = parser.buffer.buffer[parser.cursor];
                switch (yych) {
                case 0x00:    {gotoPoint = 65; continue gotoNext;}
                case '\t':    {gotoPoint = 67; continue gotoNext;}
                case '\n':    {gotoPoint = 53; continue gotoNext;}
                case '\r':    {gotoPoint = 55; continue gotoNext;}
                case ' ':    {gotoPoint = 63; continue gotoNext;}
                case ',':    {gotoPoint = 58; continue gotoNext;}
                case ':':    {gotoPoint = 57; continue gotoNext;}
                case ']':    {gotoPoint = 61; continue gotoNext;}
                case '}':    {gotoPoint = 59; continue gotoNext;}
                default:    {gotoPoint = 68; continue gotoNext;}
                }
            case 53:
                yyaccept = 0;
                yych = parser.buffer.buffer[(parser.marker = ++parser.cursor)];
                {gotoPoint = 83; continue gotoNext;}
            case 54:
                {   
...
//                          }
            ...
            case 58:
                ...
                yych = parser.buffer.buffer[(parser.marker = ++parser.cursor)];
                switch (yych) {
                case '\n':    {gotoPoint = 71; continue gotoNext;}
                case '\r':    {gotoPoint = 75; continue gotoNext;}
                case ' ':    {gotoPoint = 73; continue gotoNext;}
                default:    {gotoPoint = 56; continue gotoNext;}
                }
            case 59:
                ++parser.cursor;
            ...
            case 63:
                ++parser.cursor;
                switch ((yych = parser.buffer.buffer[parser.cursor])) {
                case '#':    {gotoPoint = 69; continue gotoNext;}
            ...
            case 67:
                yych = parser.buffer.buffer[++parser.cursor];
                {gotoPoint = 64; continue gotoNext;}
            case 68:
                yych = parser.buffer.buffer[++parser.cursor];
            ...
            case 73:
                ...
                switch (yych) {
                case ' ':    {gotoPoint = 73; continue gotoNext;}
                default:    {gotoPoint = 72; continue gotoNext;}
                }
            case 75:
                yych = parser.buffer.buffer[++parser.cursor];
                switch (yych) {
            ...
            case 79:
                ...
                switch (yych) {
                case ' ':    {gotoPoint = 79; continue gotoNext;}
                default:    {gotoPoint = 78; continue gotoNext;}
                }
            case 81:
                yych = parser.buffer.buffer[++parser.cursor];
                switch (yych) {
            ...
            case 83:
                switch (yych) {
                case '\n':
                case ' ':    {gotoPoint = 82; continue gotoNext;}
                case '\r':    {gotoPoint = 84; continue gotoNext;}
       ...
       while(true) {
        ...
        gotoNext: while(gotoPoint != -2) {
            ...
            case -1: 
                ...
                yych = parser.buffer.buffer[parser.cursor];
                switch (yych) {
                case 0x00:    {gotoPoint = 92; continue gotoNext;}
                case '\n':    {gotoPoint = 87; continue gotoNext;}
                case '\r':    {gotoPoint = 89; continue gotoNext;}
                case '"':    {gotoPoint = 94; continue gotoNext;}
                case '\\':    {gotoPoint = 91; continue gotoNext;}
                default:    {gotoPoint = 95; continue gotoNext;}
                }
            case 87:
                yyaccept = 0;
                yych = parser.buffer.buffer[(parser.marker = ++parser.cursor)];
                {gotoPoint = 109; continue gotoNext;}
            case 88:
                {
...
//                          }
            ...
            case 89:
                ++parser.cursor;
                switch ((yych = parser.buffer.buffer[parser.cursor])) {
                case '\n':    {gotoPoint = 108; continue gotoNext;}
            ...
            case 91:
                ...
                yych = parser.buffer.buffer[(parser.marker = ++parser.cursor)];
                switch (yych) {
                case '\n':    {gotoPoint = 99; continue gotoNext;}
                case '\r':    {gotoPoint = 101; continue gotoNext;}
                ...
                case 'r':
                case 't':
                case 'v':    {gotoPoint = 103; continue gotoNext;}
                case 'x':    {gotoPoint = 102; continue gotoNext;}
                default:    {gotoPoint = 90; continue gotoNext;}
                }
            case 92:
                ++parser.cursor;
            ...
            case 94:
                yych = parser.buffer.buffer[++parser.cursor];
                {gotoPoint = 93; continue gotoNext;}
            case 95:
                yych = parser.buffer.buffer[++parser.cursor];
            ...
            case 102:
                ...
                case 'd':
                case 'e':
                case 'f':    {gotoPoint = 105; continue gotoNext;}
                default:    {gotoPoint = 98; continue gotoNext;}
                }
            case 103:
                ++parser.cursor;
            ...
            case 105:
                ...
                case 'd':
                case 'e':
                case 'f':    {gotoPoint = 106; continue gotoNext;}
                default:    {gotoPoint = 98; continue gotoNext;}
                }
            case 106:
                ++parser.cursor;
            ...
            case 109:
                switch (yych) {
                case '\n':
                case ' ':    {gotoPoint = 108; continue gotoNext;}
                case '\r':    {gotoPoint = 110; continue gotoNext;}
                default:    {gotoPoint = 88; continue gotoNext;}
                }
            case 110:
                ++parser.cursor;
                if (parser.limit <= parser.cursor) parser.read();
       ...
       while(true) {
        ...
        gotoNext: while(gotoPoint != -2) {
            ...
            case -1: 
                ...
                yych = parser.buffer.buffer[parser.cursor];
                switch (yych) {
                case 0x00:    {gotoPoint = 119; continue gotoNext;}
                case '\n':    {gotoPoint = 113; continue gotoNext;}
                case '\r':    {gotoPoint = 115; continue gotoNext;}
                case '\'':    {gotoPoint = 117; continue gotoNext;}
                default:    {gotoPoint = 120; continue gotoNext;}
                }
            case 113:
                yych = parser.buffer.buffer[(parser.marker = ++parser.cursor)];
...
//                          }
            ...
            case 115:
                ...
                default:    {gotoPoint = 116; continue gotoNext;}
                }
            case 116:
                {   q.cat(parser.buffer.buffer[parser.cursor-1]);
                        break;
            ...
            case 117:
                ++parser.cursor;
                switch ((yych = parser.buffer.buffer[parser.cursor])) {
                case '\'':    {gotoPoint = 121; continue gotoNext;}
                default:    {gotoPoint = 118; continue gotoNext;}
                }
            case 118:
                {   
                        Node n = Node.allocStr();
            ...
            case 119:
                yych = parser.buffer.buffer[++parser.cursor];
                {gotoPoint = 118; continue gotoNext;}
            case 120:
                yych = parser.buffer.buffer[++parser.cursor];
                {gotoPoint = 116; continue gotoNext;}
            case 121:
                ++parser.cursor;
                {   q.cat('\'');
                        break;
            ...
            case 124:
                switch (yych) {
                case '\n':
                case ' ':    {gotoPoint = 123; continue gotoNext;}
                case '\r':    {gotoPoint = 125; continue gotoNext;}
                default:    {gotoPoint = 114; continue gotoNext;}
                }
            case 125:
                ++parser.cursor;
                if (parser.limit <= parser.cursor) parser.read();
                ...
                switch (yych) {
                case '\n':    {gotoPoint = 123; continue gotoNext;}
                default:    {gotoPoint = 126; continue gotoNext;}
                }
            case 126:
                parser.cursor = parser.marker;
       ...
       while(true) {
        ...
        gotoNext: while(gotoPoint != -2) {
            ...
            case -1: 
                ...
                yych = parser.buffer.buffer[parser.cursor];
                switch (yych) {
                case 0x00:    {gotoPoint = 129; continue gotoNext;}
                case '\n':    {gotoPoint = 131; continue gotoNext;}
                case '\r':    {gotoPoint = 133; continue gotoNext;}
                case ' ':    {gotoPoint = 132; continue gotoNext;}
                case '\\':    {gotoPoint = 135; continue gotoNext;}
                default:    {gotoPoint = 136; continue gotoNext;}
                }
            case 129:
                ++parser.cursor;
            case 130:
            ...
            case 132:
                yych = parser.buffer.buffer[++parser.cursor];
                {gotoPoint = 145; continue gotoNext;}
            case 133:
                ++parser.cursor;
                switch ((yych = parser.buffer.buffer[parser.cursor])) {
                case '\n':    {gotoPoint = 129; continue gotoNext;}
                default:    {gotoPoint = 134; continue gotoNext;}
                }
            case 134:
                {   
                        q.cat(parser.buffer.buffer[parser.cursor-1]);
            ...
            case 135:
                ...
                case 'r':
                case 't':
                case 'v':    {gotoPoint = 139; continue gotoNext;}
                case 'x':    {gotoPoint = 137; continue gotoNext;}
                default:    {gotoPoint = 134; continue gotoNext;}
                }
            case 136:
                yych = parser.buffer.buffer[++parser.cursor];
                {gotoPoint = 134; continue gotoNext;}
            case 137:
                yych = parser.buffer.buffer[++parser.cursor];
                switch (yych) {
                case '0':
                ...
                case 'd':
                case 'e':
                case 'f':    {gotoPoint = 141; continue gotoNext;}
            ...
            case 141:
                ...
                case 'd':
                case 'e':
                case 'f':    {gotoPoint = 142; continue gotoNext;}
                default:    {gotoPoint = 138; continue gotoNext;}
                }
            case 142:
                ++parser.cursor;
            ...
            case 145:
                switch (yych) {
                case ' ':    {gotoPoint = 144; continue gotoNext;}
                default:    {gotoPoint = 130; continue gotoNext;}
                }
            }
        }
       ...
       while(true) {
        ...
        gotoNext: while(gotoPoint != -2) {
            ...
            case -1: 
                ...
                yych = parser.buffer.buffer[parser.cursor];
                switch (yych) {
                case 0x00:    {gotoPoint = 154; continue gotoNext;}
                case '\n':    {gotoPoint = 148; continue gotoNext;}
                case '\r':    {gotoPoint = 150; continue gotoNext;}
                case '#':    {gotoPoint = 152; continue gotoNext;}
...
//                          }
            ...
            case 150:
                ++parser.cursor;
                switch ((yych = parser.buffer.buffer[parser.cursor])) {
                case '\n':    {gotoPoint = 166; continue gotoNext;}
            ...
            case 156:
                ...
                yych = parser.buffer.buffer[(parser.marker = ++parser.cursor)];
                switch (yych) {
                case '-':    {gotoPoint = 158; continue gotoNext;}
                default:    {gotoPoint = 151; continue gotoNext;}
                }
            case 157:
                yych = parser.buffer.buffer[++parser.cursor];
            ...
            case 158:
                yych = parser.buffer.buffer[++parser.cursor];
                switch (yych) {
                case '-':    {gotoPoint = 160; continue gotoNext;}
            ...
            case 160:
                yych = parser.buffer.buffer[++parser.cursor];
                switch (yych) {
                case '\n':    {gotoPoint = 161; continue gotoNext;}
                case '\r':    {gotoPoint = 165; continue gotoNext;}
                case ' ':    {gotoPoint = 163; continue gotoNext;}
                default:    {gotoPoint = 159; continue gotoNext;}
                }
            case 161:
                ++parser.cursor;
            ...
            case 163:
                ...
                switch (yych) {
                case ' ':    {gotoPoint = 163; continue gotoNext;}
                default:    {gotoPoint = 162; continue gotoNext;}
                }
            case 165:
                yych = parser.buffer.buffer[++parser.cursor];
                switch (yych) {
            ...
            case 167:
                ...
                case '\r':    {gotoPoint = 168; continue gotoNext;}
       ...
       parser.token = parser.cursor;
        ...
        gotoNext: while(gotoPoint != -2) {
            ...
            case -1: 
                ...
                yych = parser.buffer.buffer[parser.cursor];
                switch (yych) {
                case 0x00:    {gotoPoint = 171; continue gotoNext;}
                case '\n':    {gotoPoint = 173; continue gotoNext;}
                case '\r':    {gotoPoint = 174; continue gotoNext;}
                default:    {gotoPoint = 176; continue gotoNext;}
                }
            case 171:
                ++parser.cursor;
            case 172:
            ...
            case 173:
                yych = parser.buffer.buffer[(parser.marker = ++parser.cursor)];
                {gotoPoint = 178; continue gotoNext;}
            case 174:
                ++parser.cursor;
                switch ((yych = parser.buffer.buffer[parser.cursor])) {
            ...
            case 178:
                switch (yych) {
                case '\n':    {gotoPoint = 177; continue gotoNext;}
                case '\r':    {gotoPoint = 179; continue gotoNext;}
                default:    {gotoPoint = 172; continue gotoNext;}
                }
            case 179:
                ++parser.cursor;
                if (parser.limit <= parser.cursor) parser.read();
                ...
                switch (yych) {
                case '\n':    {gotoPoint = 177; continue gotoNext;}
                default:    {gotoPoint = 180; continue gotoNext;}
                }
            case 180:
                parser.cursor = parser.marker;
