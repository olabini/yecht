/* Generated by re2j 0.13.6.dev on Tue Jul 14 14:27:13 2009 */
package org.yecht;
        ...
        while(true) {
            gotoNext: while(true) {
                ...
                case -1: 
                    ...
                    yych = parser.buffer.buffer[parser.cursor];
                    switch (yych) {
                    case 0x00:    gotoPoint = 170; break gotoNext;
                    case '\n':    gotoPoint = 172; break gotoNext;
                    case '\r':    gotoPoint = 173; break gotoNext;
                    default:    gotoPoint = 175; break gotoNext;
                    }
                case 170:
                    ++parser.cursor;
                case 171:
                ...
                case 172:
                    yych = parser.buffer.buffer[(parser.marker = ++parser.cursor)];
                    gotoPoint = 177; break gotoNext;
                case 173:
                    ++parser.cursor;
                    switch ((yych = parser.buffer.buffer[parser.cursor])) {
                    case '\n':    gotoPoint = 176; break gotoNext;
                    default:    gotoPoint = 174; break gotoNext;
                    }
                case 174:
                    {   continue comment; 
                    }
                ...
                case 177:
                    switch (yych) {
                    case '\n':    gotoPoint = 176; break gotoNext;
                    case '\r':    gotoPoint = 178; break gotoNext;
                ...
                case 178:
                    ...
                    switch (yych) {
                    case '\n':    gotoPoint = 176; break gotoNext;
                    default:    gotoPoint = 179; break gotoNext;
                    }
                case 179:
                    parser.cursor = parser.marker;
