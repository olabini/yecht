/* Generated by re2j 0.13.6.dev on Tue Jul 14 13:49:33 2009 */
package org.yecht;
        ...
        while(true) {
            gotoNext: while(true) {
                ...
                case -1: 
                    ...
                    case '\n':    gotoPoint = 154; break gotoNext;
                    case '\r':    gotoPoint = 155; break gotoNext;
                ...
                case 154:
                    yych = parser.buffer.buffer[(parser.marker = ++parser.cursor)];
                    gotoPoint = 159; break gotoNext;
                case 155:
                    ++parser.cursor;
                    switch ((yych = parser.buffer.buffer[parser.cursor])) {
                    case '\n':    gotoPoint = 158; break gotoNext;
                    default:    gotoPoint = 156; break gotoNext;
                    }
                case 156:
                    {   continue comment; 
                    }
                ...
                case 159:
                    switch (yych) {
                    case '\n':    gotoPoint = 158; break gotoNext;
                    case '\r':    gotoPoint = 160; break gotoNext;
                ...
                case 160:
                    ...
                    switch (yych) {
                    case '\n':    gotoPoint = 158; break gotoNext;
                    default:    gotoPoint = 161; break gotoNext;
                    }
                case 161:
                    parser.cursor = parser.marker;
